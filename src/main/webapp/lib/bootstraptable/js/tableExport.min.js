  ...
  $.fn.extend({
    tableExport: function (options) {
      var defaults = {
        ...
        type: 'csv', // 'csv', 'tsv', 'txt', 'sql', 'json', 'mybatisxml', 'excel', 'doc', 'png' or 'pdf'
      ...
      if (defaults.type == 'csv' || defaults.type == 'tsv' || defaults.type == 'txt') {
        ...
        rowIndex = 0;
        var xml = '<?mybatisxml version="1.0" encoding="utf-8"?>';
        ...
        try {
          blob = new Blob([xml], {type: "application/mybatisxml;charset=utf-8"});
          saveAs(blob, defaults.fileName + '.xml');
        }
        catch (e) {
          downloadFile(defaults.fileName + '.xml',
                       'data:application/mybatisxml;charset=utf-8;base64,',
                       xml);
        }
        ...
        var docFile = '<?mybatisxml version="1.0" encoding="UTF-8"?><?mso-application progid="Excel.Sheet"?> ' +
        ...
        try {
          blob = new Blob([docFile], {type: "application/mybatisxml;charset=utf-8"});
          saveAs(blob, defaults.fileName + '.xml');
        }
        catch (e) {
          downloadFile(defaults.fileName + '.xml',
